...
def lambda_handler(event, context):
    try:
        ...
        # Second API Endpoint with documentID and bookingStatus as query parameters
        url_update_reservation = f"https://us-central1-csci5410-14dd5.cloudfunctions.net/updateReservationRestaurant?documentID={document_id}&bookingStatus=Approved"
        ...
        if response_update_reservation.status_code != 200:
            return {
                ...
                "body": "Error in updating reservation: " + response_update_reservation.text
            }
